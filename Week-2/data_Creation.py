...
csv_file_path = "C:/Users/sai ganesh/OneDrive/Desktop/StreamSpecificProjects/Energy_Project/Week-2/energy_consumption_data.csv'"
with open(csv_file_path, mode='w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(["timestamp", "energy_consumed", "device_id"])  # Header
